        ...
        <div>
            ...
            <footer class="text-white body-font bg-gray-800">
                    ...
                    <div class="bg-gray-100">
                        ...
                        <p class="text-gray-500 text-sm text-center sm:text-left">© 2020 DJI — Official Website
                            <a href="https://twitter.com/jahed_ripon" rel="noopener noreferrer" class="text-white ml-1" target="_blank">@Jahed</a>
                        </p>
